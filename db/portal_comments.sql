...
COMMENT ON COLUMN model_atrb.attr_nm IS '속성명 (영문)';
COMMENT ON COLUMN model_atrb.attr_nm_ko IS '속성명 (한글)';
...
COMMENT ON COLUMN model_atrb.fk_ref_attr IS 'FK 참조 속성명';
...
COMMENT ON COLUMN ppln_exec.dur_sec IS '소요 시간 (초)';
...
COMMENT ON COLUMN dbt_model.run_dur_sec IS '최종 실행 소요시간 (초)';
...
COMMENT ON COLUMN didntf_rule.prty IS '우선순위';
...
COMMENT ON COLUMN domn_qlity_score.unqns IS '유일성 점수 (%)';
...
-- ntfc
COMMENT ON TABLE  ntfc IS '사용자 알림';
COMMENT ON COLUMN ntfc.noti_id IS '알림 고유 ID (PK, 자동증가)';
COMMENT ON COLUMN ntfc.usr_id IS '수신자 FK → usr_acnt';
COMMENT ON COLUMN ntfc.noti_ty IS '알림 유형: system/approval/quality/security/pipeline';
COMMENT ON COLUMN ntfc.tit IS '알림 제목';
COMMENT ON COLUMN ntfc.msg IS '알림 내용';
COMMENT ON COLUMN ntfc.link_url IS '관련 화면 링크';
COMMENT ON COLUMN ntfc.is_read IS '읽음 여부';
COMMENT ON COLUMN ntfc.read_at IS '읽은 일시';
COMMENT ON COLUMN ntfc.crtd_at IS '등록일시';
COMMENT ON COLUMN ntfc.crtd_by IS '등록자 ID';
COMMENT ON COLUMN ntfc.updtd_at IS '수정일시';
COMMENT ON COLUMN ntfc.updtd_by IS '수정자 ID';
...
COMMENT ON COLUMN widg_tmplat.min_hgt IS '최소 높이 (그리드 단위)';
COMMENT ON COLUMN widg_tmplat.max_width IS '최대 너비 (그리드 단위)';
COMMENT ON COLUMN widg_tmplat.max_hgt IS '최대 높이 (그리드 단위)';
...
COMMENT ON COLUMN usr_widg_layout.hgt IS '높이 (그리드 단위)';
